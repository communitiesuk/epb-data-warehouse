...
RSpec.configure do |config|
  ...
  config.before do
    DatabaseCleaner.strategy = [:truncation, { only: %w[assessment_attribute_values assessment_documents assessments_country_ids assessment_search audit_logs assessments_address_id] }]
