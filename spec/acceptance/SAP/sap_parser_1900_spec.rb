  ...
  context "when loading xml from SAP" do
    ...
    it "parses the document in the expected format" do
      expectation = { "schema_version_original" => "SAP-Schema-19.0.0",
                      ...
                      "secondary_heating" =>
                       { "description" => "Electric heater", "energy_efficiency_rating" => 0, "environmental_efficiency_rating" => 0 },
                      "hot_water" =>
                      ...
                      "renewable_heat_incentive" => { "rhi_new_dwelling" => { "space_heating" => 13_120, "water_heating" => 2285 } },
