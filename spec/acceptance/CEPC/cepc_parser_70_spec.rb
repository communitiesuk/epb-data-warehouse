                      ...
                      "summary_of_performance" =>
                       { "building_data" =>
                          [{ "analysis_type" => "ACTUAL",
                             ...
                             "activities" => [{ "id" => 1010, "area" => 142.6 }, { "id" => 1030, "area" => 66.9 }, { "id" => 1032, "area" => 58.4 }, { "id" => 1036, "area" => 4.8 }, { "id" => 1031, "area" => 41.1 }],
                             "global_performance" =>
                             ...
                             "hvac_systems" =>
                               [{ "area" => 142.6,
                                  ...
                                  "fuel_type" => "Oil",
                                  "mj_m2_heating_dem" => 604.144,
                                  "mj_m2_cooling_dem" => 47.0757,
                                  "kwh_m2_heating" => 0,
                                  "kwh_m2_cooling" => 0,
                                  "kwh_m2_auxiliary" => 0,
                                  "heating_sseff" => 0,
                                ...
                                { "area" => 171.2,
                                  ...
                                  "heating_gen_seff" => 1,
                                  "cooling_gen_seer" => 0,
                                  "activities" => [{ "id" => 1030, "area" => 66.9 }, { "id" => 1032, "area" => 58.4 }, { "id" => 1036, "area" => 4.8 }, { "id" => 1031, "area" => 41.1 }] }] },
                           { "analysis_type" => "NOTIONAL",
                             ...
                             "hvac_systems" =>
                               [{ "area" => 142.6,
                                  ...
                                  "heat_source" => "LTHW boiler",
                                  "fuel_type" => "Oil",
                                  "mj_m2_heating_dem" => 179.595,
                                  "mj_m2_cooling_dem" => 18.7903,
                                  "kwh_m2_heating" => 0,
                                  "kwh_m2_cooling" => 0,
                                  "kwh_m2_auxiliary" => 0,
                                  "heating_sseff" => 0,
