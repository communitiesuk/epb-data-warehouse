describe "the parser and the CEPC configuration for schema 6.0" do
  let(:use_case) { UseCase::ParseXmlCertificate.new }

  context "when loading XML from CEPC" do
    let(:cepc) { Samples.xml "CEPC-6.0", "cepc" }

    it "parses the document in the expected format" do
      expectation = { "issue_date" => "2020-05-14",
                      "report_type" => 3,
                      ...
                      "summary_of_performance" =>
                       { "building_data" =>
                          [{ "analysis_type" => "ACTUAL", "area" => 402.6, "area_exterior" => 1058.32, "weather" => "LON", "q50_infiltration" => 10, "building_w_k" => 411.86, "building_w_m2k" => 0.389164, "building_alpha" => 18.3412, "activities" => [{ "id" => 1005, "area" => 402.6 }], "global_performance" => { "kwh_m2_heating" => 41.0355, "kwh_m2_cooling" => 25.3865, "kwh_m2_auxiliary" => 39.0832, "kwh_m2_lighting" => 54.0787, "kwh_m2_dhw" => 2.77834, "kwh_m2_equipment" => 42.185, "kwh_m2_natural_gas" => 41.0355, "kwh_m2_lpg" => 0, "kwh_m2_biogas" => 0, "kwh_m2_oil" => 0, "kwh_m2_coal" => 0, "kwh_m2_anthracite" => 0, "kwh_m2_smokeless" => 0, "kwh_m2_dual_fuel" => 0, "kwh_m2_biomass" => 0, "kwh_m2_supplied" => 121.327, "kwh_m2_waste_heat" => 0, "kwh_m2_district_heating" => 0, "kwh_m2_displaced" => 6.10442, "kwh_m2_pvs" => 3.07665, "kwh_m2_wind" => 3.02777, "kwh_m2_chp" => 0, "kwh_m2_ses" => 0.801605 }, "hvac_systems" => [{ "area" => 402.6, "type" => "Fan coil systems", "heat_source" => "LTHW boiler", "fuel_type" => "Natural Gas", "mj_m2_heating_dem" => 122.171, "mj_m2_cooling_dem" => 179.401, "kwh_m2_heating" => 41.0355, "kwh_m2_cooling" => 25.3865, "kwh_m2_auxiliary" => 39.0832, "heating_sseff" => 0.827, "cooling_sseer" => 1.963, "heating_gen_seff" => 0.89, "cooling_gen_seer" => 2.5, "activities" => [{ "id" => 1005, "area" => 402.6 }] }] },
                           { "analysis_type" => "NOTIONAL", "area" => 402.6, "area_exterior" => 1058.32, "weather" => "LON", "q50_infiltration" => 3, "building_w_k" => 362.524, "building_w_m2k" => 0.342547, "building_alpha" => 11.2489, "activities" => [{ "id" => 1005, "area" => 402.6 }], "global_performance" => { "kwh_m2_heating" => 18.1582, "kwh_m2_cooling" => 7.46769, "kwh_m2_auxiliary" => 14.0716, "kwh_m2_lighting" => 14.4489, "kwh_m2_dhw" => 3.33761, "kwh_m2_equipment" => 42.185, "kwh_m2_natural_gas" => 18.1582, "kwh_m2_lpg" => 0, "kwh_m2_biogas" => 0, "kwh_m2_oil" => 3.33761, "kwh_m2_coal" => 0, "kwh_m2_anthracite" => 0, "kwh_m2_smokeless" => 0, "kwh_m2_dual_fuel" => 0, "kwh_m2_biomass" => 0, "kwh_m2_supplied" => 35.9883, "kwh_m2_waste_heat" => 0, "kwh_m2_district_heating" => 0, "kwh_m2_displaced" => 0, "kwh_m2_pvs" => 0, "kwh_m2_wind" => 0, "kwh_m2_chp" => 0, "kwh_m2_ses" => 0 }, "hvac_systems" => [{ "area" => 402.6, "type" => "Fan coil systems", "heat_source" => "LTHW boiler", "fuel_type" => "Natural Gas", "mj_m2_heating_dem" => 53.5375, "mj_m2_cooling_dem" => 96.7814, "kwh_m2_heating" => 18.1581, "kwh_m2_cooling" => 7.46769, "kwh_m2_auxiliary" => 14.0716, "heating_sseff" => 0.819, "cooling_sseer" => 3.6, "heating_gen_seff" => 0, "cooling_gen_seer" => 0, "activities" => [{ "id" => 1005, "area" => 402.6 }] }] },
                           { "analysis_type" => "REFERENCE", "area" => 402.6, "area_exterior" => 1058.32, "weather" => "LON", "q50_infiltration" => 10, "building_w_k" => 718.761, "building_w_m2k" => 0.679153, "building_alpha" => 10, "activities" => [{ "id" => 1005, "area" => 402.6 }], "global_performance" => { "kwh_m2_heating" => 71.9516, "kwh_m2_cooling" => 25.6538, "kwh_m2_auxiliary" => 2.16062, "kwh_m2_lighting" => 45.54, "kwh_m2_dhw" => 6.41192, "kwh_m2_equipment" => 42.185, "kwh_m2_natural_gas" => 78.3634, "kwh_m2_lpg" => 0, "kwh_m2_biogas" => 0, "kwh_m2_oil" => 0, "kwh_m2_coal" => 0, "kwh_m2_anthracite" => 0, "kwh_m2_smokeless" => 0, "kwh_m2_dual_fuel" => 0, "kwh_m2_biomass" => 0, "kwh_m2_supplied" => 73.3544, "kwh_m2_waste_heat" => 0, "kwh_m2_district_heating" => 0, "kwh_m2_displaced" => 0, "kwh_m2_pvs" => 0, "kwh_m2_wind" => 0, "kwh_m2_chp" => 0, "kwh_m2_ses" => 0 }, "hvac_systems" => [{ "area" => 402.6, "type" => "Fan coil systems", "heat_source" => "LTHW boiler", "fuel_type" => "Natural Gas", "mj_m2_heating_dem" => 189.088, "mj_m2_cooling_dem" => 207.795, "kwh_m2_heating" => 71.9516, "kwh_m2_cooling" => 25.6538, "kwh_m2_auxiliary" => 2.16062, "heating_sseff" => 0.73, "cooling_sseer" => 2.25, "heating_gen_seff" => 0, "cooling_gen_seer" => 0, "activities" => [{ "id" => 1005, "area" => 402.6 }] }] }] },
                      "or_assessment_start_date" => "2020-05-14",
                      "or_assessment_end_date" => "2030-05-14",
                      "or_building_data" => { "hvac_system" => "Yes", "other_hvac_system" => "Yes", "internal_environment" => "Yes", "assessment_period_alignment" => "Yes" },
                      "or_usable_floor_area" => { "ufa_1" => { "floor_area" => 100 } },
                      "or_benchmark_data" => { "benchmarks" => [{ "benchmark_id" => 1, "floor_area" => 403 }] },
                      "or_energy_consumption" => { "anthracite" => { "consumption" => 12.6, "end_date" => "2030-12-25", "estimate" => 3, "start_date" => "2019-12-25" } },
                      "renewable_energy_source" => [{ "start_date" => "2019-12-25", "end_date" => "2030-12-25", "name" => "Solar panel", "generation" => 20, "energy_type" => 2 }],
                      "transaction_type" => 1,
                      "asset_rating" => 80,
                      ...
                      "ter" => 23.2,
                      "tyr" => 67.98,
                      "technical_information" => { "main_heating_fuel" => "Natural Gas", "building_environment" => "Air Conditioning", "floor_area" => 403, "building_level" => 3, "or_availability_date" => "2020-01-04", "other_fuel_description" => "Test", "special_energy_uses" => "Test sp", "renewable_sources" => "Renewable sources test" },
                      "ac_questionnaire" => { "ac_present" => "No", "ac_rated_output" => { "ac_kw_rating" => 100 }, "ac_estimated_output" => 3, "ac_inspection_commissioned" => 1 } }
  ...
  context "when loading XML from CEPC-RR" do
    let(:cepc_rr) { Samples.xml "CEPC-6.0", "cepc+rr" }
    ...
    it "parses the document in the expected format" do
      expectation = { "address_line_1" => "Some Unit",
                      ...
                      "related_rrn" => "5555-0000-0000-0000-0001",
                      "report_type" => 4,
                      "scheme_assessor_id" => "SPEC000000",
                      ...
                      "status" => "cancelled",
                      "technical_information" => { "building_environment" => "Natural Ventilation Only", "floor_area" => 10 },
                      "uprn" => 1,
                      "valid_until" => "2021-05-03" }

      actual = use_case.execute(xml: cepc_rr,
                                schema_type: "CEPC-6.0",
                                assessment_id: "5555-0000-0000-0000-0002")
      expect(actual).to eq(expectation)
    end
  end

  context "when loading XML from DEC" do
    let(:dec) { Samples.xml "CEPC-6.0", "dec" }

    it "parses the document in the expected format" do
      expectation = { "ac_questionnaire" => { "ac_estimated_output" => 1, "ac_inspection_commissioned" => 1, "ac_present" => "Yes", "ac_rated_output" => { "ac_kw_rating" => 1 } },
                      "address_line_1" => "Some Unit",
                      "address_line_2" => "2 Lonely Street",
                      "address_line_3" => "Some Area",
                      "address_line_4" => "Some County",
                      ...
                      "or_benchmark_data" => { "benchmarks" => [{ "benchmark_id" => 1, "floor_area" => 15, "name" => "Library", "occupancy_level" => "level", "tufa" => 1840 }] },
  ...
  context "when loading XML from DEC-RR" do
    let(:dec_rr) { Samples.xml "CEPC-6.0", "dec-rr" }
    ...
    it "parses the document in the expected format" do
      expectation = { "issue_date" => "2020-05-04",
                      ...
                      "technical_information" => { "renewable_sources" => "Renewable source", "special_energy_uses" => "Special discount", "building_environment" => "Air Conditioning", "floor_area" => 10 },
