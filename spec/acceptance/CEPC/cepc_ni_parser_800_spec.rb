                ...
                [{ "analysis_type" => "ACTUAL",
                   ...
                   "hvac_systems" =>
                     [{ "area" => 186.96,
                        ...
                        "fuel_type" => "Oil",
                        "mj_m2_heating_dem" => 681.135,
                        "mj_m2_cooling_dem" => 67.2481,
                        "kwh_m2_heating" => 0,
                        "kwh_m2_cooling" => 0,
                        "kwh_m2_auxiliary" => 0,
                        "heating_sseff" => 0,
                        ...
                        "heating_gen_seff" => 0,
                        "cooling_gen_seer" => 0,
                        "activities" => [{ "id" => 1200, "area" => 83.87 }, { "id" => 1188, "area" => 66.29 }, { "id" => 1203, "area" => 18.42 }, { "id" => 1199, "area" => 18.38 }] },
                      { "area" => 709.6,
                        "type" => "Constant volume system (variable fresh air rate)",
                        "heat_source" => "LTHW boiler",
                        "fuel_type" => "Natural Gas",
                        "mj_m2_heating_dem" => 465.981,
                        "mj_m2_cooling_dem" => 159.574,
                        "kwh_m2_heating" => 180.278,
                        "kwh_m2_cooling" => 21.5072,
                        "kwh_m2_auxiliary" => 147.627,
                        "heating_sseff" => 0.718,
                        "cooling_sseer" => 2.061,
                        "heating_gen_seff" => 0.92,
                        "cooling_gen_seer" => 3.37,
                        "activities" =>
                         [{ "id" => 1207, "area" => 27.58 },
                          { "id" => 1192, "area" => 649.84 },
                          { "id" => 1203, "area" => 20.15 },
                      ...
                      { "area" => 147.32,
                        ...
                        "heat_source" => "Heat pump: air source",
                        "fuel_type" => "Grid Supplied Electricity",
                        "mj_m2_heating_dem" => 402.558,
                        "mj_m2_cooling_dem" => 26.8911,
                        "kwh_m2_heating" => 38.4664,
                        "kwh_m2_cooling" => 3.98598,
                        "kwh_m2_auxiliary" => 18.0494,
                        "heating_sseff" => 2.907,
                        "cooling_sseer" => 1.874,
                        "heating_gen_seff" => 3.12,
                        "cooling_gen_seer" => 2.64,
                        "activities" => [{ "id" => 1191, "area" => 138.41 }, { "id" => 1203, "area" => 8.91 }] },
                      { "area" => 180.22,
                        "type" => "Split or multi-split system",
                        "heat_source" => "Heat pump: air source",
                        "fuel_type" => "Grid Supplied Electricity",
                        "mj_m2_heating_dem" => 409.986,
                        "mj_m2_cooling_dem" => 41.6254,
                        "kwh_m2_heating" => 33.7637,
                        "kwh_m2_cooling" => 5.39301,
                        "kwh_m2_auxiliary" => 131.333,
                        "heating_sseff" => 3.373,
                        "cooling_sseer" => 2.144,
                        "heating_gen_seff" => 3.62,
                        "cooling_gen_seer" => 3.02,
                        "activities" => [{ "id" => 1187, "area" => 180.22 }] },
                      { "area" => 261.95,
                        "type" => "Split or multi-split system",
                        "heat_source" => "Heat pump: air source",
                        "fuel_type" => "Grid Supplied Electricity",
                        "mj_m2_heating_dem" => 611.235,
                        "mj_m2_cooling_dem" => 139.602,
                        "kwh_m2_heating" => 53.4258,
                        "kwh_m2_cooling" => 22.6642,
                        "kwh_m2_auxiliary" => 28.7152,
                        "heating_sseff" => 3.178,
                        "cooling_sseer" => 1.711,
                        "heating_gen_seff" => 3.41,
                        "cooling_gen_seer" => 2.41,
                        "activities" => [{ "id" => 1200, "area" => 3.61 }, { "id" => 1192, "area" => 258.34 }] },
                      { "area" => 12.39,
                 ...
                 { "analysis_type" => "NOTIONAL",
                   ...
                   "global_performance" =>
                     { "kwh_m2_heating" => 15.6057,
                       ...
                       "kwh_m2_chp" => 0,
                       "kwh_m2_ses" => 0 },
                   "hvac_systems" => [{ "area" => 186.96,
                                        "type" => "No Heating or Cooling",
                                        "heat_source" => "LTHW boiler",
                                        "fuel_type" => "Oil",
                                        "mj_m2_heating_dem" => 412.869,
                                        "mj_m2_cooling_dem" => 178.201,
                                        "kwh_m2_heating" => 0,
                                        "kwh_m2_cooling" => 0,
                                        "kwh_m2_auxiliary" => 0,
                                        "heating_sseff" => 0,
                                      ...
                                      { "area" => 709.6,
                                        ...
                                        "heat_source" => "LTHW boiler",
                                        "fuel_type" => "Natural Gas",
                                        "mj_m2_heating_dem" => 71.0466,
                                        "mj_m2_cooling_dem" => 153.375,
                                        "kwh_m2_heating" => 24.9181,
                                        "kwh_m2_cooling" => 11.8345,
                                        "kwh_m2_auxiliary" => 73.7921,
                                        "heating_sseff" => 0.792,
                                        "cooling_sseer" => 3.6,
                                        "heating_gen_seff" => 0,
                                        "cooling_gen_seer" => 0,
                                      ...
                                      { "area" => 147.32,
                                        ...
                                        "heat_source" => "Heat pump: air source",
                                        "fuel_type" => "Grid Supplied Electricity",
                                        "mj_m2_heating_dem" => 84.8079,
                                        "mj_m2_cooling_dem" => 30.7484,
                                        "kwh_m2_heating" => 9.69454,
                                        "kwh_m2_cooling" => 2.37256,
                                        "kwh_m2_auxiliary" => 17.4672,
                                        "heating_sseff" => 2.43,
                                        "cooling_sseer" => 3.6,
                                        "heating_gen_seff" => 0,
                                        "cooling_gen_seer" => 0,
                                      ...
                                      { "area" => 180.22,
                                        ...
                                        "heat_source" => "Heat pump: air source",
                                        "fuel_type" => "Grid Supplied Electricity",
                                        "mj_m2_heating_dem" => 46.5265,
                                        "mj_m2_cooling_dem" => 66.4948,
                                        "kwh_m2_heating" => 5.31853,
                                        "kwh_m2_cooling" => 5.1308,
                                        "kwh_m2_auxiliary" => 56.6569,
                                        "heating_sseff" => 2.43,
                                        "cooling_sseer" => 3.6,
                                        "heating_gen_seff" => 0,
                                        "cooling_gen_seer" => 0,
                                      ...
                                      { "area" => 261.95,
                                        ...
                                        "heat_source" => "Heat pump: air source",
                                        "fuel_type" => "Grid Supplied Electricity",
                                        "mj_m2_heating_dem" => 97.8404,
                                        "mj_m2_cooling_dem" => 204.029,
                                        "kwh_m2_heating" => 11.1843,
                                        "kwh_m2_cooling" => 15.743,
                                        "kwh_m2_auxiliary" => 27.7889,
                                        "heating_sseff" => 2.43,
                                        "cooling_sseer" => 3.6,
                                        "heating_gen_seff" => 0,
                                        "cooling_gen_seer" => 0,
