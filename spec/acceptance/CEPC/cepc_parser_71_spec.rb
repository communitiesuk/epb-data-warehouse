                      ...
                      "summary_of_performance" =>
                       { "building_data" =>
                          [{ "analysis_type" => "ACTUAL",
                             ...
                             "activities" => [{ "id" => 1078, "area" => 6.84 }, { "id" => 1077, "area" => 3.42 }, { "id" => 1074, "area" => 43.89 }, { "id" => 1305, "area" => 167.51 }],
                             "global_performance" =>
                             ...
                             "hvac_systems" =>
                               [{ "area" => 54.15,
                                  ...
                                  "mj_m2_heating_dem" => 637.668,
                                  "mj_m2_cooling_dem" => 82.8076,
                                  "kwh_m2_heating" => 221.413,
                                  "kwh_m2_cooling" => 0,
                                  "kwh_m2_auxiliary" => 8.58942,
                                  "heating_sseff" => 0.8,
                                  "cooling_sseer" => 0,
                                  "heating_gen_seff" => 1,
                                  "cooling_gen_seer" => 0,
                                  "activities" => [{ "id" => 1078, "area" => 6.84 }, { "id" => 1077, "area" => 3.42 }, { "id" => 1074, "area" => 43.89 }] },
                                { "area" => 167.51,
                                  ...
                                  "heating_gen_seff" => 1,
                                  "cooling_gen_seer" => 0,
                                  "activities" => [{ "id" => 1305, "area" => 167.51 }] }] },
                           { "analysis_type" => "NOTIONAL",
                             ...
                             "hvac_systems" =>
                               [{ "area" => 54.15,
                                  ...
                                  "heat_source" => "Room heater",
                                  "fuel_type" => "Oil",
                                  "mj_m2_heating_dem" => 247.357,
                                  "mj_m2_cooling_dem" => 32.988,
                                  "kwh_m2_heating" => 83.8955,
                                  "kwh_m2_cooling" => 0,
                                  "kwh_m2_auxiliary" => 2.29051,
                                  "heating_sseff" => 0.819,
                                  "cooling_sseer" => 0,
                                  "heating_gen_seff" => 0,
                                  "cooling_gen_seer" => 0,
