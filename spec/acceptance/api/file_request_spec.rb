...
describe "FileController" do
  ...
  it_behaves_like "a file info API endpoint", file_name: "display", type: "csv"
  it_behaves_like "a file info API endpoint", file_name: "display", type: "json"
  it_behaves_like "a file info API endpoint", file_name: "display-recommendations", type: "json"
end
