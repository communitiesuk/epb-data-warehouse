describe 'HTTP requests made to the register API' do

context "when making a request to the register API for an assessment" do
  ...
  it 'can convert the json received' do
