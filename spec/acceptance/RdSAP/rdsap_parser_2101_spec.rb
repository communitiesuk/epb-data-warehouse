RSpec.describe "the parser and the rdsap configuration" do
  ...
  context "when loading xml from RdSap" do
    let(:rdsap) do
      Samples.xml("RdSAP-Schema-21.0.1")
    end
    ...
    it "parses the document in the expected format" do
      expectation = { "calculation_software_name" => "SomeSoft RdSAP Calculator",
                      ...
                      "roofs" =>
                       [{ "description" => { "language" => "1", "value" => "Pitched, 25 mm loft insulation" },
                          "energy_efficiency_rating" => 2,
                          "environmental_efficiency_rating" => 2 },
                        { "description" => { "language" => "1", "value" => "Pitched, 250 mm loft insulation" },
                          "energy_efficiency_rating" => 4,
                          "environmental_efficiency_rating" => 4 }],
                      "floors" =>
                       [{ "description" => { "language" => "1", "value" => "Suspended, no insulation (assumed)" },
                          "energy_efficiency_rating" => 0,
                          "environmental_efficiency_rating" => 0 },
                        { "description" => { "language" => "1", "value" => "Solid, insulated (assumed)" },
                          "energy_efficiency_rating" => 0,
                          "environmental_efficiency_rating" => 0 }],
                      "window" =>
                      ...
                      "main_heating" =>
                       [{ "description" => { "language" => "1", "value" => "Boiler and radiators, anthracite" },
                          "energy_efficiency_rating" => 3,
                          "environmental_efficiency_rating" => 1 },
                        { "description" => { "language" => "1", "value" => "Boiler and radiators, mains gas" },
                          "energy_efficiency_rating" => 4,
                          "environmental_efficiency_rating" => 4 }],
                      "main_heating_controls" =>
                       [{ "description" => { "language" => "1", "value" => "Programmer, room thermostat and TRVs" },
                          "energy_efficiency_rating" => 4,
                          "environmental_efficiency_rating" => 4 },
                        { "description" => { "language" => "1", "value" => "Time and temperature zone control" },
                      ...
                      "hot_water" =>
                       { "description" => { "language" => "1", "value" => "From main system" },
                         ...
                         "environmental_efficiency_rating" => 4 },
                      "lighting" =>
                       { "description" => { "language" => "1", "value" => "Low energy lighting in 50% of fixed outlets" },
                         "energy_efficiency_rating" => 4,
                         "environmental_efficiency_rating" => 4 },
                      "secondary_heating" =>
                       { "description" => { "language" => "1", "value" => "Room heaters, electric" },
                         "energy_efficiency_rating" => 0,
                         "environmental_efficiency_rating" => 0 },
                      ...
                      "suggested_improvements" => [{ "energy_performance_rating" => 70, "environmental_impact_rating" => 70, "improvement_category" => 5, "improvement_details" => { "improvement_number" => 66 }, "improvement_type" => "G", "indicative_cost" => "£220 - £250", "sequence" => 1, "typical_saving" => 139 }, { "energy_performance_rating" => 72, "environmental_impact_rating" => 73, "improvement_category" => 5, "improvement_details" => { "improvement_number" => 19 }, "improvement_type" => "N", "indicative_cost" => "£4,000 - £7,000", "sequence" => 2, "typical_saving" => 49 }, { "energy_performance_rating" => 83, "environmental_impact_rating" => 75, "improvement_category" => 5, "improvement_details" => { "improvement_number" => 34 }, "improvement_type" => "U", "indicative_cost" => "£8,000 - £10,000", "sequence" => 3, "typical_saving" => 286 }],
