  ...
  context "when the queues gateway is functioning correctly" do
    ...
    context "when processing updates" do
      ...
      it "updates the relevant certificates in the document store" do
        ...
        expect(documents_gateway).to have_received(:set_top_level_attribute).with(assessment_id: "0000-0000-0000-0000-0000", top_level_attribute: "matched_uprn", new_value: "4444444444").exactly(1).times
      end
