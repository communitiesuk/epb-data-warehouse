...
describe "Domestic NI Materialized View" do
  ...
  before(:all) do
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0112", assessment_address_id:, schema_type: "SAP-Schema-NI-11.2", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0120", assessment_address_id:, schema_type: "SAP-Schema-NI-12.0", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2022-05-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0130", assessment_address_id:, schema_type: "SAP-Schema-NI-13.0", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2022-06-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0140", assessment_address_id:, schema_type: "SAP-Schema-NI-14.0", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2022-07-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0141", assessment_address_id:, schema_type: "SAP-Schema-NI-14.1", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2022-08-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0142", assessment_address_id:, schema_type: "SAP-Schema-NI-14.2", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2022-09-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0150", assessment_address_id:, schema_type: "SAP-Schema-NI-15.0", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2022-10-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0160", assessment_address_id:, schema_type: "SAP-Schema-NI-16.0", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2022-11-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0161", assessment_address_id:, schema_type: "SAP-Schema-NI-16.1", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2022-12-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0171", assessment_address_id:, schema_type: "SAP-Schema-NI-17.1", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2023-02-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0172", assessment_address_id:, schema_type: "SAP-Schema-NI-17.2", type_of_assessment: "SAP", type: "sap", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2023-03-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0173", assessment_address_id:, schema_type: "SAP-Schema-NI-17.3", type_of_assessment: "SAP", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2023-04-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0174", assessment_address_id:, schema_type: "SAP-Schema-NI-17.4", type_of_assessment: "SAP", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2023-05-05T12:00:00.000+00:00", "country_id": 3
    })
    ...
    # SAP-Schema-NI-18.0.0 - SAP (SAP only schema)
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-0180", assessment_address_id:, schema_type: "SAP-Schema-NI-18.0.0", type_of_assessment: "SAP", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2023-06-05T12:00:00.000+00:00", "country_id": 3
    })

    # RdSAP-Schema-NI-18.0 - RdSAP (RdSAP only schema)
    ...
    # RdSAP-Schema-NI-19.0 - RdSAP (RdSAP only schema)
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-1190", assessment_address_id:, schema_type: "RdSAP-Schema-NI-19.0", type_of_assessment: "RdSAP", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2023-06-05T12:00:00.000+00:00", "country_id": 3
    })

    # RdSAP-Schema-NI-20.0.0 - RdSAP (RdSAP only schema)
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-1200", assessment_address_id:, schema_type: "RdSAP-Schema-NI-20.0.0", type_of_assessment: "RdSAP", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2023-06-05T12:00:00.000+00:00", "country_id": 3
    })

    # RdSAP-Schema-NI-21.0.0 - RdSAP (RdSAP only schema)
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-1210", assessment_address_id:, schema_type: "RdSAP-Schema-NI-21.0.0", type_of_assessment: "RdSAP", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2023-06-05T12:00:00.000+00:00", "country_id": 3
    })

    # RdSAP-Schema-NI-21.0.1 - RdSAP (RdSAP only schema)
    add_assessment_eav(assessment_id: "1000-0000-0000-0000-1211", assessment_address_id:, schema_type: "RdSAP-Schema-NI-21.0.1", type_of_assessment: "RdSAP", different_fields: {
      "postcode": "BT10 0AA", "registration_date": "2023-06-05T12:00:00.000+00:00", "country_id": 3
    })
  ...
  it "returns rows for each NI assessment ordered by certificate_number" do
    expect(query_result.pluck("certificate_number")).to eq %w[
      ...
      1000-0000-0000-0000-0173
      1000-0000-0000-0000-0174
      1000-0000-0000-0000-0180
      ...
      1000-0000-0000-0000-1190
      1000-0000-0000-0000-1200
      1000-0000-0000-0000-1210
      1000-0000-0000-0000-1211
    ]
  end

  context "when checking data in the materialized view" do
    let(:expected_ni_112_sap_data) do
      { "certificate_number" => "1000-0000-0000-0000-0112",
    ...
    let(:expected_ni_112_rdsap_data) do
      { "certificate_number" => "1000-0000-0000-0000-1112",
        "address1" => "1 Some Street",
        "address2" => "Some Area",
        "address3" => "Some County",
        "address" => "1 Some Street, Some Area, Some County",
    ...
    let(:expected_ni_180_sap_data) do
      { "certificate_number" => "1000-0000-0000-0000-0180",
        "address1" => "999 Letsbe Avenue",
    ...
    let(:expected_ni_190_rdsap_data) do
      { "certificate_number" => "1000-0000-0000-0000-1190",
        "address1" => "35, Address Lane",
        "address2" => nil,
        "address3" => nil,
        "address" => "35, Address Lane",
        "postcode" => "BT10 0AA",
        ...
        "photo_supply" => "0",
        "wind_turbine_count" => 0,
        "lighting_cost_current" => "98",
        "lighting_cost_potential" => "98",
        "heating_cost_current" => "1010",
        "heating_cost_potential" => "877",
    ...
    let(:expected_ni_200_rdsap_data) do
      { "certificate_number" => "1000-0000-0000-0000-1200",
        "address1" => "34 CENTRAL ROAD",
        "address2" => nil,
        "address3" => nil,
        "address" => "34 CENTRAL ROAD",
        "postcode" => "BT10 0AA",
        ...
        "co2_emiss_curr_per_floor_area" => "61",
        "co2_emissions_potential" => "2.5",
        "total_floor_area" => "41",
        "lodgement_date" => "2023-06-05",
        "report_type" => "2",
        "posttown" => "FABRICATED TOWN",
        "lodgement_datetime" => "2021-07-21 11:26:28",
        ...
        "heating_cost_current" => "325",
        "heating_cost_potential" => "325",
        "hot_water_cost_current" => "163",
        "hot_water_cost_potential" => "163",
        "multi_glaze_proportion" => "100",
        ...
        "mainheatcont_description" => "Manual charge control",
        ...
        "floor_height" => "2.4",
        "main_heating_controls" => "Manual charge control",
        "local_authority" => "N09000003",
        "local_authority_label" => "Belfast",
        "constituency_label" => "Belfast South",
        "constituency" => "N06000003",
    ...
    let(:expected_ni_210_rdsap_data) do
      { "certificate_number" => "1000-0000-0000-0000-1210",
        "address1" => "1 Some Street",
        "address2" => nil,
        "address3" => nil,
        "address" => "1 Some Street",
    ...
    let(:expected_ni_211_rdsap_data) do
      { "certificate_number" => "1000-0000-0000-0000-1211",
        "address1" => "1 Some Street",
        "address2" => nil,
        "address3" => nil,
        "address" => "1 Some Street",
    ...
    it "returns a row with the required data for SAP-NI 11.2 and of assessment_type sap" do
      result = query_result.find { |i| i["certificate_number"] == "1000-0000-0000-0000-0112" }
      expect(result).to eq expected_ni_112_sap_data
    end

    it "returns a row with the required data for SAP-NI 11.2 and of assessment_type rdsap" do
      result = query_result.find { |i| i["certificate_number"] == "1000-0000-0000-0000-1112" }
      expect(result).to eq expected_ni_112_rdsap_data
    end
    ...
    # RdSAP-Schema-NI-18.0 test (RdSAP only)
    it "returns a row with the required data for RdSAP-NI 18.0 and of assessment_type rdsap" do
      result = query_result.find { |i| i["certificate_number"] == "1000-0000-0000-0000-1180" }
      expect(result).to eq expected_ni_180_rdsap_data
    end

    # SAP-Schema-NI-18.0.0 test (SAP only)
    it "returns a row with the required data for SAP-NI 18.0.0 and of assessment_type sap" do
      result = query_result.find { |i| i["certificate_number"] == "1000-0000-0000-0000-0180" }
      expect(result).to eq expected_ni_180_sap_data
    end

    # RdSAP-Schema-NI-19.0 test (RdSAP only)
    it "returns a row with the required data for RdSAP-NI 19.0 and of assessment_type rdsap" do
      result = query_result.find { |i| i["certificate_number"] == "1000-0000-0000-0000-1190" }
      expect(result).to eq expected_ni_190_rdsap_data
    end

    # RdSAP-Schema-NI-20.0.0 test (RdSAP only)
    it "returns a row with the required data for RdSAP-NI 20.0.0 and of assessment_type rdsap" do
      result = query_result.find { |i| i["certificate_number"] == "1000-0000-0000-0000-1200" }
      expect(result).to eq expected_ni_200_rdsap_data
    end

    # RdSAP-Schema-NI-21.0.0 test (RdSAP only)
    it "returns a row with the required data for RdSAP-NI 21.0.0 and of assessment_type rdsap" do
      result = query_result.find { |i| i["certificate_number"] == "1000-0000-0000-0000-1210" }
      expect(result).to eq expected_ni_210_rdsap_data
    end

    # RdSAP-Schema-NI-21.0.1 test (RdSAP only)
    it "returns a row with the required data for RdSAP-NI 21.0.1 and of assessment_type rdsap" do
      result = query_result.find { |i| i["certificate_number"] == "1000-0000-0000-0000-1211" }
      expect(result).to eq expected_ni_211_rdsap_data
    end
  end
