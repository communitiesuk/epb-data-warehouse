...
describe "Domestic Materialized View" do
  ...
  before(:all) do
    ...
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0020", assessment_address_id:, schema_type: "SAP-Schema-14.0", type_of_assessment:, type: "sap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0021", assessment_address_id:, schema_type: "SAP-Schema-14.0", type_of_assessment: "RdSAP", type: "rdsap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0024", assessment_address_id:, schema_type: "SAP-Schema-12.0", type_of_assessment:, type: "sap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0025", assessment_address_id:, schema_type: "SAP-Schema-12.0", type_of_assessment: "RdSAP", type: "rdsap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })

    import_look_ups(schema_versions: %w[RdSAP-Schema-21.0.1 RdSAP-Schema-21.0.0 RdSAP-Schema-20.0.0 SAP-Schema-19.0.0 SAP-Schema-16.0 SAP-Schema-16.1 SAP-Schema-15.0 SAP-Schema-14.2 SAP-Schema-14.1 SAP-Schema-14.0 SAP-Schema-12.0])
  ...
  context "when checking data in the materialized view" do
    let(:expected_sap_120_rdsap_data) do
      { "certificate_number" => "0000-0000-0000-0000-0025",
    ...
    let(:expected_sap_120_sap_data) do
      { "certificate_number" => "0000-0000-0000-0000-0024",
        "address1" => "1 Some Street",
        "address2" => "Some Area",
        "address3" => "Some County",
        "address" => "1 Some Street, Some Area, Some County",
    ...
    let(:expected_sap_140_rdsap_data) do
    ...
    let(:expected_sap_140_sap_data) do
    ...
    let(:expected_sap_141_rdsap_data) do
    ...
    let(:expected_sap_141_sap_data) do
      { "certificate_number" => "0000-0000-0000-0000-0018",
        "address1" => "1 Some Street",
        "address2" => "Some Area",
        "address3" => "Some County",
        "address" => "1 Some Street, Some Area, Some County",
    ...
    it "returns a row with the required data for SAP 12.0 and of assessment_type sap" do
      result = query_result.find { |i| i["certificate_number"] == "0000-0000-0000-0000-0024" }
    ...
    it "returns a row with the required data for SAP 14.0 and of assessment_type sap" do
      result = query_result.find { |i| i["certificate_number"] == "0000-0000-0000-0000-0020" }
    ...
    it "returns a row with the required data for SAP 14.1 and of assessment_type sap" do
      result = query_result.find { |i| i["certificate_number"] == "0000-0000-0000-0000-0018" }
