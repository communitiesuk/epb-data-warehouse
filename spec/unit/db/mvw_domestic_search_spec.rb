...
describe "Domestic Materialized View" do
  ...
  before(:all) do
    ...
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0022", assessment_address_id:, schema_type: "SAP-Schema-13.0", type_of_assessment:, type: "sap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0023", assessment_address_id:, schema_type: "SAP-Schema-13.0", type_of_assessment: "RdSAP", type: "rdsap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })
    ...
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0026", assessment_address_id:, schema_type: "SAP-Schema-11.0", type_of_assessment:, type: "sap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0027", assessment_address_id:, schema_type: "SAP-Schema-11.0", type_of_assessment: "RdSAP", type: "rdsap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0028", assessment_address_id:, schema_type: "SAP-Schema-11.2", type_of_assessment:, type: "sap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0029", assessment_address_id:, schema_type: "SAP-Schema-11.2", type_of_assessment: "RdSAP", type: "rdsap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })
    add_assessment_eav(assessment_id: "0000-0000-0000-0000-0030", assessment_address_id:, schema_type: "SAP-Schema-10.2", type_of_assessment: "RdSAP", type: "rdsap", different_fields: {
      "postcode": "SW10 0AA", "registration_date": "2022-04-05T12:00:00.000+00:00", "country_id": 1
    })

    import_look_ups(schema_versions: %w[RdSAP-Schema-21.0.1 RdSAP-Schema-21.0.0 RdSAP-Schema-20.0.0 SAP-Schema-19.0.0 SAP-Schema-16.0 SAP-Schema-16.1 SAP-Schema-15.0 SAP-Schema-14.2 SAP-Schema-14.1 SAP-Schema-14.0 SAP-Schema-13.0 SAP-Schema-12.0 SAP-Schema-11.2 SAP-Schema-11.0 SAP-Schema-10.2])
  ...
  it "returns rows for each assessment in England & Wales ordered by certificate_number" do
    expect(date_filtered_results.pluck("certificate_number")).to eq %w[
      ...
      0000-0000-0000-0000-0030
    ]
  end

  context "when checking data in the materialized view" do
    let(:expected_sap_102_rdsap_data) do
      { "certificate_number" => "0000-0000-0000-0000-0030",
    ...
    let(:expected_sap_110_rdsap_data) do
      { "certificate_number" => "0000-0000-0000-0000-0027",
        "address1" => "1 Some Street",
        "address2" => "Some Area",
        "address3" => "Some County",
        "address" => "1 Some Street, Some Area, Some County",
    ...
    let(:expected_sap_110_sap_data) do
      { "certificate_number" => "0000-0000-0000-0000-0026",
        "address1" => "1 Some Street",
        "address2" => "Some Area",
        "address3" => "Some County",
        "address" => "1 Some Street, Some Area, Some County",
    ...
    let(:expected_sap_112_rdsap_data) do
      { "certificate_number" => "0000-0000-0000-0000-0029",
        "address1" => "1 Some Street",
        "address2" => "Some Area",
        "address3" => "Some County",
        "address" => "1 Some Street, Some Area, Some County",
    ...
    let(:expected_sap_112_sap_data) do
      { "certificate_number" => "0000-0000-0000-0000-0028",
        "address1" => "1 Some Street",
        "address2" => "Some Area",
        "address3" => "Some County",
        "address" => "1 Some Street, Some Area, Some County",
    ...
    let(:expected_sap_130_rdsap_data) do
      { "certificate_number" => "0000-0000-0000-0000-0023",
        "address1" => "1 Some Street",
        "address2" => "Some Area",
        "address3" => "Some County",
        "address" => "1 Some Street, Some Area, Some County",
    ...
    let(:expected_sap_130_sap_data) do
      { "certificate_number" => "0000-0000-0000-0000-0022",
        "address1" => "1 Some Street",
        "address2" => "Some Area",
        "address3" => "Some County",
        "address" => "1 Some Street, Some Area, Some County",
    ...
    it "returns a row with the required data for SAP 10.2 and of assessment_type rdsap" do
      result = query_result.find { |i| i["certificate_number"] == "0000-0000-0000-0000-0030" }
      expect(result).to eq expected_sap_102_rdsap_data
    end

    it "returns a row with the required data for SAP 11.0 and of assessment_type sap" do
      result = query_result.find { |i| i["certificate_number"] == "0000-0000-0000-0000-0026" }
    ...
    it "returns a row with the required data for SAP 11.2 and of assessment_type sap" do
      result = query_result.find { |i| i["certificate_number"] == "0000-0000-0000-0000-0028" }
      expect(result).to eq expected_sap_112_sap_data
    end

    it "returns a row with the required data for SAP 11.2 and of assessment_type rdsap" do
      result = query_result.find { |i| i["certificate_number"] == "0000-0000-0000-0000-0029" }
      expect(result).to eq expected_sap_112_rdsap_data
    end

    it "returns a row with the required data for SAP 13.0 and of assessment_type sap" do
      result = query_result.find { |i| i["certificate_number"] == "0000-0000-0000-0000-0022" }
