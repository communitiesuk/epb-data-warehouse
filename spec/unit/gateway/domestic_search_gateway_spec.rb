...
describe Gateway::DomesticSearchGateway do
  ...
  describe "#fetch" do
    ...
    context "when creating the materialized view" do
      let(:expected_data) do
        { "rrn" => "0000-0000-0000-0000-0001",
          ...
          "potential_energy_efficiency" => nil,
    ...
    document -> 'lighting_cost_current' ->> 'value' AS LIGHTING_COST_CURRENT,
    document -> 'lighting_cost_potential' ->> 'value' AS LIGHTING_COST_POTENTIAL,
    document -> 'heating_cost_current' ->> 'value' AS HEATING_COST_CURRENT,
    document -> 'heating_cost_potential' ->> 'value' AS HEATING_COST_POTENTIAL,
    document -> 'hot_water_cost_current' ->> 'value' AS HOT_WATER_COST_CURRENT,
    document -> 'hot_water_cost_potential' ->> 'value' AS HOT_WATER_COST_POTENTIAL,
    ...
    document ->> 'current_energy_efficiency_rating' as CURRENT_ENERGY_EFFICIENCY,
    document ->> 'potential_energy_efficiency_rating' as POTENTIAL_ENERGY_EFFICIENCY,
