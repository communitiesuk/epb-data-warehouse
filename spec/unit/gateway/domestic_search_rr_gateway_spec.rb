...
describe "Domestic Recommendations Report" do
  ...
  describe "#fetch_rr" do
    before(:all) do
      ...
      add_countries
      add_assessment_eav(assessment_id: "0000-0000-0000-0000-0009", schema_type: "SAP-Schema-16.1", type_of_assessment: "SAP", type: "sap", add_to_assessment_search: true, different_fields: {
      ...
      add_assessment_eav(assessment_id: "0000-0000-0000-0000-0010", schema_type: "RdSAP-Schema-21.0.1", type_of_assessment: "RdSAP", type: "epc", add_to_assessment_search: true, different_fields: {
        "postcode": "SW10 0AA", "country_id": 1
      })
