describe Gateway::DocumentsGateway, :set_with_timecop do
  ...
  describe "fetch_by_id" do
    ...
    context "when fetching a Wales json document" do
      let(:redaction_hash) do
        { status: "entered",
          tenure: 1,
          region_code: 17,
      ...
      let(:assessment_id) { "0044-2222-3333-4444-1111" }

      before do
        gateway.add_assessment(assessment_id:, document: json_sample)
        Gateway::AssessmentSearchGateway.new.insert_assessment(assessment_id:, document: assessment_data, country_id: 2)
        Gateway::AssessmentsCountryIdGateway.new.insert(assessment_id:, country_id: 2)
      end
