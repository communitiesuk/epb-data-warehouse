describe Gateway::MaterializedViewsGateway do
  ...
  describe "#fetch_all" do
    ...
    it "returns an array of one view name" do
      views = %w[mvw_avg_co2_emissions mvw_commercial_ni_search mvw_commercial_ni_rr_search mvw_commercial_search mvw_domestic_ni_rr_search mvw_domestic_rr_search mvw_dec_search mvw_dec_rr_search mvw_domestic_ni_search mvw_domestic_search mvw_commercial_rr_search]
