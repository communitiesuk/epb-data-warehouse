describe "redis queue mainipulation" do
  ...
  context 'start redis servive and manipulate ' do
    ...
    context "it persists data across requests" do
      before do
        redis.set "asssessmets", ["0000-0000-0000-0000-0000"].to_json
      end
      ...
      it "the existing key's value is incremented to have an array of 2 values" do
        ...
        expect(JSON.parse(redis.get("asssessmets"))).to eq(["0000-0000-0000-0000-0000", "0000-0000-0000-0000-0001"])
      end
    end
    ...
    context "when can store complex data of many queues" do
      ...
      let(:queues) {
        { asssessmets: ["5555-0000-0000-0000-0000", "5555-0000-0000-0000-0001"],
          opt_outs:    ["9999-0000-0000-0000-5444", "9999-0000-0000-0000-4444"],
        }
      }
