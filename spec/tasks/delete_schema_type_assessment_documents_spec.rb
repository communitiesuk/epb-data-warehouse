describe "Delete schema type certificates from assessment_documents rake" do
  include_context "when lodging XML"

  before do
    ActiveRecord::Base.connection.execute("TRUNCATE assessment_documents")
  end

  context "when calling the rake task" do
    subject(:task) { get_task("one_off:delete_schema_type_assessment_documents") }
