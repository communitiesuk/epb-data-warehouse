module Gateway
  module QueueNames
    ...
    QUEUE_NAMES = %i[assessments assessments_backfill cancelled opt_outs assessments_address_update matched_address_update backfill_matched_address_update].freeze
