...
--
-- Name: mvw_commercial_ni_search; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--

CREATE MATERIALIZED VIEW public.mvw_commercial_ni_search AS
...
CREATE MATERIALIZED VIEW public.mvw_domestic_ni_search AS
 SELECT ad.assessment_id AS certificate_number,
    s.address_line_1 AS address1,
    s.address_line_2 AS address2,
    s.address_line_3 AS address3,
...
--
-- Name: vw_commercial_ni_yesterday; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.vw_commercial_ni_yesterday AS
 SELECT ad.assessment_id AS certificate_number,
    public.get_attribute_value('address_line_1'::character varying, ad.assessment_id) AS address1,
    public.get_attribute_value('address_line_2'::character varying, ad.assessment_id) AS address2,
    public.get_attribute_value('address_line_3'::character varying, ad.assessment_id) AS address3,
...
--
-- Name: vw_domestic_ni_yesterday; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.vw_domestic_ni_yesterday AS
 SELECT ad.assessment_id AS certificate_number,
    s.address_line_1 AS address1,
    s.address_line_2 AS address2,
    s.address_line_3 AS address3,
