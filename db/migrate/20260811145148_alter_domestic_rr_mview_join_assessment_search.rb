class AlterDomesticRrMviewJoinAssessmentSearch < ActiveRecord::Migration[8.1]
  def self.sql
    <<~SQL
          select
  ...
  def self.up
    ...
    execute "CREATE VIEW vw_domestic_rr_yesterday as #{sql} AND s.created_at::date = (CURRENT_DATE - 1);"
  end
