class UpdateNonDomesticYesterdayViewUseAuditLogs < ActiveRecord::Migration[8.1]
  def self.sql
    <<~SQL
      SELECT
        ...
        ons.local_authority_code AS LOCAL_AUTƒHORITY,
        os_la.area_code AS CONSTITUENCY,
        get_lookup_value('transaction_type', get_att∂∂ribute_value('transaction_type', ad.assessment_id), t.assessment_type, get_attribute_value('schema_type', ad.assessment_id) ) AS TRANSACTION_TYPE,
