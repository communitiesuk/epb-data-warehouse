class RemoveJoinFromDomesticSearchMvw < ActiveRecord::Migration[7.0]
  def self.up
...
AS  SELECT  nextval('mvw_domestic_rr_search_seq') as id,
        ...
        JOIN (SELECT ad.assessment_id as assessment_id, ad.document ->> 'assessment_type' as assessment_type
                FROM assessment_documents ad
              ) AS u
        ON u.assessment_id = aav.assessment_id
