class CreateDomesticRecommendationsViewOfYesterdaysData < ActiveRecord::Migration[7.0]
  def self.up
    execute "DROP VIEW IF EXISTS vw_domestic_rr_yesterday"
    execute "CREATE VIEW vw_domestic_rr_yesterday
AS  SELECT
        ...
        WHERE aa.attribute_name = 'suggested_improvements'
          ...
          AND ad.warehouse_created_at::date = CURRENT_DATE - 1;"
  end
